...
client.ayarlar = {
  "prefix": "!", //prefix
  "oauthSecret": "FNa7t-0RjMT3ENgyrzC3PMZ_oR1ANL99", //bot secreti
	"callbackURL": "https://gcrx-botlist.glitch.me/callback", //benim sitenin urlsini kendin ile değiş "/callback" kalacak!
	"kayıt": "737400414441439272", //onaylandı, reddedildi, başvuru yapıldı falan kayıtların gideceği kanalın ID'ini yazacaksın
  "renk": "RANDOM" //embedların rengini burdan alıo can sıkıntısdna yapılmış bişe falan fln
};

client.yetkililer = ["690918038463184908", "711236973440008203","627790288831643659", "679025888549142529"]
...
client.login("NzM3Mzk0MjQwMTU3Mzg0ODE0.Xx8t5g.zZUlWA9c90JvqFk7px9YjBOGiK4") //tokeni yaz işte

process.env = {}
process.env.TOKEN = "NzM3Mzk0MjQwMTU3Mzg0ODE0.Xx8t5g.zZUlWA9c90JvqFk7px9YjBOGiK4";
